...
const SuccessCounter = () => {
  ...
  className="hero "
  style={{
    backgroundImage: "url(https://i.ibb.co.com/RTJ94xby/159033430582442485-vdm-1.jpg)",
  }}>
  ...
  <div className="py-12">
     ...
     <div className=" mx-auto rounded-xl py-8     grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 ">
       ...
       <div className="bg-base-300 py-12 p-12 rounded-xl border border-pink-500  text-center">
